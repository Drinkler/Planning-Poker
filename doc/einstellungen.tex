...
%% des Dokuments.
\setzematrikelnr{7474265, 1234567}
\setzekurs{TINF-18B}
\setzetitel{Umsetzung einer responsiven Webanwendung für Aufwandsschätzungen Agiler Projekte}
\setzedatumAbgabe{01. Juni 2020}
\setzefirma{Balluff GmbH, camos GmbH}
\setzefirmenort{Stuttgart}
\setzeabgabeort{Stuttgart}
\setzestudiengang{Informatik}
\setzedhbw{Stuttgart}
\setzebetreuer{Dr. Simon A. Frank}
\setzegutachter{Dr. Simon A. Frank}
\setzezeitraum{8 Wochen}
\setzearbeit{Praxisprojekt}
